        ...
        if (testRunEvent.type === 'started') {
            ...
            if (testRunEvent.state === 'running') {
                if (!suiteNode && this.runningSuite && (typeof testRunEvent.suite === 'object')) {
                    ...
                    suiteNode = new testSuiteNode_1.TestSuiteNode(this, testRunEvent.suite, this.runningSuite, false);
            ...
            if (testNode) {
                testNode.setCurrentState(testRunEvent.state, testRunEvent.message, testRunEvent.decorations, testRunEvent.description, testRunEvent.tooltip);
            }
        }
